...
import { cancelOrderAdmin } from "../serivce";
import { useRequest } from "ahooks";
import { ToastCustom } from "@/components/ui/Toast";
import { EOrderStatus } from "@/utils/common";

interface IModalDeleteOrder {
  reloadList?: VoidFunction;
}

const ModalDeleteOrder = (props: IModalDeleteOrder, ref?: any) => {
...
export default forwardRef(ModalDeleteOrder);
